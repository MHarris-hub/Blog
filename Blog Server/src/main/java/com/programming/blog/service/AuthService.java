...
import com.programming.blog.security.JWTProvider;
...
public class AuthService {
    ...
    //creates a new user and commits it to database - password is encrypted using BCrypt
    ...
    //user login - successful user login is issued a JWT
